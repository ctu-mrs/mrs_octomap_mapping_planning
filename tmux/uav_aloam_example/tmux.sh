...
PROJECT_NAME=aloam_octomap_example
...
'
  'Octomap' 'waitForOdometry; roslaunch octomap_mapping_planning mapplan.launch config_octomap:=./custom_configs/octomap.yaml config_pcl_filter_ouster:=./custom_configs/ouster_filter_mapping.yaml config_pathfinder:=./custom_configs/pathfinder.yaml config_trajectory_generation:=./custom_configs/trajectory_generation.yaml world_frame_id:='"$UAV_NAME"'/slam_origin
'
